...
def handle_message(event):
    ...
    response = openai.ChatCompletion.create(
        ...
        messages=[
            ...
            {"role": "system", "content": "當客人點餐時，請務必回復品項和數量，例如：'好的，你點的是一杯美式，價格是50元，請問您需要冰的還是熱的？' 或 '好的，您要一杯榛果拿鐵，價格為80元。請問還有其他需要幫忙的嗎？'"},
            {"role": "system", "content": "當客人點餐時輸入一杯拿鐵和拿鐵一杯時，都是在點一杯拿鐵的意思"},
